...
# CỦA VIỆT NAM TRÊN THỊ TRƯỜNG TÀI CHÍNH (VERSION 7 - STABLE)
# ============================================================
            ...
            if not GEMINI_OK:
                ...
                if not api_key:
                    ...
                    try:
                        ...
                        # Khởi tạo mô hình Gemini (Sử dụng 1.5-flash-latest hoặc gemini-pro để tương thích)
